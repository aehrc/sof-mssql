...
describe("ViewDefinitionParser", () => {
  ...
  describe("parseViewDefinition", () => {
    it("should parse a valid ViewDefinition", () => {
      const result =
        ViewDefinitionParser.parseViewDefinition(validViewDefinition);
    ...
    it("should throw error for invalid resource type", () => {
      ...
      expect(() => ViewDefinitionParser.parseViewDefinition(invalid)).toThrow(
    ...
    it("should throw error for missing select", () => {
      ...
      expect(() => ViewDefinitionParser.parseViewDefinition(invalid)).toThrow(
        "must have at least one select element",
      );
    });
  ...
  describe("parseTestSuite", () => {
      ...
      tests: [
        {
          ...
          expect: [{ id: "test-patient", gender: "male" }],
        },
      ],
    };
    ...
    it("should throw error for missing required fields", () => {
      ...
      expect(() => ViewDefinitionParser.parseTestSuite(invalid)).toThrow(
